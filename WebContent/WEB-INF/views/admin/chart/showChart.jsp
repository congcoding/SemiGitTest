		...
		$.ajax({
			...
			var citymap = {
		      ...
		      //서울마크
				...
				//markerSeoul.addListener('click', toggleBounceS);
				 markerSeoul.addListener('click',infowindows); 
				 //markerKangwon.removeListener(infowindowk); 
				...
				//markerKangwon.addListener('click', toggleBounceK);
				...
				//markerChungcheong.addListener('click', toggleBounceC);
				...
				//markerJeonla.addListener('click', toggleBounceJ);
				...
				//markerGyeongsang.addListener('click', toggleBounceG);
